...
struct MaterialDesignTextFieldwithoutImage: View {
...
struct MaterialDesignTextFieldwithoutImage_Previews: PreviewProvider {
    static var previews: some View {
        MaterialDesignTextFieldwithoutImage(.constant(""), placeholder: "", hint: .constant(""), editing: .constant(false), valid: .constant(false), BorderColor: .constant(Color(hex: 0xF15865)))
    }
}
