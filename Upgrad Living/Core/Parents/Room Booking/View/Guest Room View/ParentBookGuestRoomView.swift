...
struct ParentBookGuestRoomView: View {
                    ...
                    VStack{
                        ...
                        VStack(spacing: 15){
                            ForEach(arrGuestInfo) { info in
                                ParentBookGuestRoomCell(arrguest: info)
                                    .onTapGesture {
                                        refrenceID = info.id ?? ""
                        ...
                        NavigationLink(
                            "",
                            destination: ParentConfirmedGuestRoom(refrenceID: refrenceID).navigationBarHidden(true),
