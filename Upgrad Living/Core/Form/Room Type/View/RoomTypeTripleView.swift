...
struct RoomTypeTripleView: View {
        ...
        VStack{
            HStack{
                ...
                VStack(alignment: .leading, spacing: 5){
                    HStack(spacing: 4){
                        Text("Triple Sharing Room".uppercased())
                            .font(.custom(OpenSans_Bold, size: 14))
                            .foregroundColor(Color(hex: 0x333333))
                        Image("Triple_Sharing")
                            .resizable()
                            .scaledToFit()
...
struct RoomTypeTripleView_Previews: PreviewProvider {
