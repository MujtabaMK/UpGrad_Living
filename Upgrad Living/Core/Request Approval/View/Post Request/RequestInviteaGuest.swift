...
struct RequestInviteaGuest: View {
                ...
                VStack{
                                ...
                                .overlay {
                                    HStack{
                                        ...
                                        TextField("", text: $guestNo)
                                            ...
                                            .foregroundColor(Color(hex: 0x333333))
                                            .disableAutocorrection(true)
                                            .onReceive(Just(guestNo)) { newValue in
                                                if guestNo.count > 10 {
                                                    guestNo = String(guestNo.prefix(10))
                                                }
                                            }
                                    }
                                }
                    ...
                    Button {
                        if startDate.isEmpty{
                            ...
                            alertMessage = "Please enter reason to Invite a guest"
                            AlertShow = "0"
                            showingAlert = true
                        }else if guestName.isEmpty{
                            alertMessage = "Please enter guest name"
                            AlertShow = "0"
                            showingAlert = true
                        }else if guestNo.isEmpty{
                            alertMessage = "Please enter guest number"
                            AlertShow = "0"
                            showingAlert = true
                        }else{
                            callAPI.toggle()
