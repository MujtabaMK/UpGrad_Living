            ...
            ZStack{
                ScrollView(showsIndicators: false) {
                    ...
                    VStack{
                        ...
                        NavigationLink(
                            "",
                            destination: GuestRoomSuccessView(isHome: $isBackGuestRoom).navigationBarHidden(true),
                            isActive: $isconfirm).isDetailLink(false)
                        
                        NavigationLink(
                            "",
                            destination: BookGuestRoomView().navigationBarHidden(true),
